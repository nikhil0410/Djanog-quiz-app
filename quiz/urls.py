...
from .views import QuizListView, CategoriesListView,\
    ...
    QuizMarkingDetail, QuizDetailView, QuizTake, index, login_user, logout_user, kiddos,register,addUser,signup
